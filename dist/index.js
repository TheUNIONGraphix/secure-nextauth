...
const SecureSessionContext = require$$0.createContext({
    isAuthenticated: false,
});
const useSecureSession = () => {
    const context = require$$0.useContext(SecureSessionContext);
...
function useAuthStatus(config) {
    const [isAuthenticated, setIsAuthenticated] = require$$0.useState(false);
